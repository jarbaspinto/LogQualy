...
public class CriarNovoUsuarioActivity extends AppCompatActivity {

    private static final String TAG = "CriarNovoUsuarioActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmail = findViewById(R.id.editTextCriarContaEmail);
        mSenha = findViewById(R.id.editTextCriarContaSenha);
        mButtonCriarConta = findViewById(R.id.buttonCriarConta);
        ...
        mButtonCriarConta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAuth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(CriarNovoUsuarioActivity.this, new OnCompleteListener<AuthResult>() {
